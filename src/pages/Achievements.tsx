...
const achievements = [
  {
    icon: Globe,
    title: "International Recognition & Diplomatic Impact",
    description:
      "Awarded a Certificate of Appreciation by the Embassy of Ghana in Beijing in recognition of outstanding support and sponsorship for Ghana’s 69th Independence Anniversary Commemoration",
    highlights: [
      "This recognition highlights our role in strengthening China–Africa relations, fostering cross-cultural collaboration, and supporting diplomatic initiatives on the global stage.",
    ],
  ...
  },
  {
    ...
    image: cert,
    impact: { metric: "69th", label: "Independence Anniversary of Ghana" },
  },
  {
    icon: Lightbulb,
    title: "Scientific & Technological Innovation Awards",
    description:
      "Recognized by the Shenzhen Illuminating Society for outstanding contributions to scientific and technological advancement",
    highlights: [
      "First Prize – Science & Technology Innovation Award: Solar Streetlights with Self-Cleaning and Self-Organizing Network Remote Control Awarded to Guangdong Suiming Photoelectric Co., Ltd.",
      "Second Prize – Science & Technology Innovation Award: Multiple innovative projects in intelligent lighting, smart systems, and high-efficiency technologies, including, Advanced LED street lighting systems, Intelligent cockpit vision diagnostics, High-brightness 4K laser projection solutions",
    ],
    image: shenzhen,
    impact: { metric: "5+", label: "Awards-winning Projects" },
  },
  {
    icon: Users,
    title: "Certified Scientific Achievement & Research Excellence",
    description:
      "Certified for the “Research and Application of Solar Street Lights with Self-Cleaning and Self-Organizing Network Remote Control Capabilities”, recognized as:",
    highlights: [
      "Achievement Level: Leading Domestically",
      "Evaluated by: Guangdong Optoelectronic Technology Association",
      "Validated by Experts from: South China University of Technology, South China Normal University, Wuyi University, Foshan University, Guangdong Institute of Product Quality Supervision and Inspection",
    ],
    image: certificate,
    impact: { metric: "Certificate", label: "EVALUATION OF SCIENTIFIC AND TECHNOLOGICAL ACHIEVEMENTS" },
  },
];
      ...
      <section ref={heroRef} className="relative pt-24 pb-20 md:pt-32 md:pb-28 overflow-hidden">
        ...
        <motion.div className="container-elegant relative z-10" style={{ y: contentY, opacity: contentOpacity }}>
          <div className="max-w-3xl">
            ...
            >
              Milestones of Excellence, Innovation <br />& <span className="text-gradient-gold">Lasting Impact</span>
            </h1>
            <motion.div
            ...
            >
              Every milestone reflects our commitment to excellence—delivering transformative outcomes, driving innovation, and creating meaningful change worldwide.
            </p>
          </div>
        </motion.div>
      </section>
      ...
      <section className="section-padding bg-background">
        <div className="container-elegant">
          <div className="text-center mb-16">
            <span className="text-refined text-accent mb-3 block">Our Achievements</span>
            <h2 className="font-serif text-3xl md:text-4xl font-medium text-foreground mb-4">
              Recognized Excellence, Global Impact & Innovation
            </h2>
